...
class SchoolTestsDetailController {
  ...
  constructor($scope, $stateParams, $q, school_test, SchoolTestService,
              SchoolTestResultService) {
    this.$scope_ = $scope;
  ...
  updateTestResult() {
    ...
    this.school_test =
        this.SchoolTestService_.get({'id' : this.school_test_id})
            .$promise.then(function(data) { scope.ctrl.school_test = data; });
  }
}
